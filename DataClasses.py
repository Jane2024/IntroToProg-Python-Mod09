...
# MBruce, 9.5.2022, modified for Assignment9
# ---------------------------------------------------------- #
...
class Person:
    ...
    changelog: (When,Who,What)
        ...
        MBruce,9.5.2022, Modified for Assignment09
    """
...
class Employee(Person):  # Inherits from Person
    ...
    changelog: (When,Who,What)
        RRoot,1.1.2030,Created Class
        MBruce,9.7.2022, modified employee_id setter from "self.__last_name = value" to "self.__employee_id = value".
    """
